...
%w(git vim zlib1g-dev libssl-dev libreadline6-dev libyaml-dev libpq-dev postgresql-client-9.3 libmysqlclient-dev build-essential mysql-client-5.6).each do |pkg|
  apt_package pkg do
    action :install
  end
end
